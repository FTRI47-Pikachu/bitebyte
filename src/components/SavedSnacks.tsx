...
<fieldset>
  <legend className="text-lg font-medium text-gray-900">Lorem ipsum dolor sit</legend>

  <p className="mt-1 text-pretty text-sm text-gray-700">
    Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur, culpa.
  </p>
    ...
    <button type="button" className="text-gray-600 hover:text-gray-700">
      ...
      >
        ...
        <ul className="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <li>
            <a href="#" className="group block overflow-hidden border border-gray-200 rounded-lg shadow">
              <img
